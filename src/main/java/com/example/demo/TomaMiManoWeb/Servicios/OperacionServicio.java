...
public class OperacionServicio {
    ...
    @Transactional
    public  void registrarOperacion(String titulo, String detalle, TipoOperacion tipoOperacion, MultipartFile archivo,String id_usu) throws ErrorServicio {
        validar(titulo,detalle,tipoOperacion);
        Operacion operacion =  new Operacion();
        operacion.setUsuario(usuarioRepositorio.getOne(id_usu));
